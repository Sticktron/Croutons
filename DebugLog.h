...
//  NSLog wrapper
//
//  DebugLog(msg)			print Class, Selector, msg				Obj-C
//  DebugLog0				print Class, Selector					Obj-C
//  DebugLogMore(msg)		print Filename, Line, Signature, msg	Obj-C
//  DebugLogC(msg)			print msg								C
//
//  -Sticktron
//
